...
import useLogin from './login_function'; // Adjust the path to your useLogin hook
        ...
        <div className="container-fluid" id="white-part">
            <div className="white-content">
                <div className="contents">
                    ...
                    <p className="text-center">Vous n'avez pas de compte ? Inscrivez-vous dès maintenant</p>
                </div>
            </div>
            <CircleLogoComponent />
        </div>
